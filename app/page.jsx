        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center relative z-10">
          ...
          <div className="text-center sm:text-left">
            <span className="text-gray-500 font-light tracking-wide mb-6">
              evently<span className="text-purple-400">*</span>
            </span>

            <h1 className="text-5xl sm:text-6xl md:text-7xl ont-bold mb-6 leading-[0.95] tracking-tight">
              Discover &<br/>
              create amazing
              <br/>
            ...
            <p className="text-lg sm:text-xl text-gray-400 mb-12 max-w-lg font-light">
              Whethe you&pos;re hosting or attending, evently makes every event
